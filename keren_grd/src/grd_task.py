...
class GrdTask :
    ...
    def initialize_with_files(self, destination_folder_name, domain_file, template_file, hyps_file_name, observability_file_name = None, action_token_file_name = None, poi_hyps_file = None, task_name=None, reciprocal_observability_file_name = None, domain_name = grd_defs.NA):
        ...
        if domain_name == 'NA':
            self.domain_name = 'placeholder'

        #assign the relevant file names
        self.destination_folder_name = destination_folder_name
        self.domain_file_name = domain_file
        #self.full_domain_file_name = f'{destination_folder_name}{domain_file.replace("../","")}'
        self.full_domain_file_name = os.path.join(destination_folder_name, self.domain_file_name.replace('../',''))
        ...
        self.full_template_file_name = os.path.join(destination_folder_name, self.template_file_name.replace('../', ''))
        #self.full_template_file_name = f'{destination_folder_name}{template_file.replace("../","")}'
        ...
        self.full_hyps_file_name = os.path.join(destination_folder_name, self.hyps_file_name.replace('../', ''))
        #self.full_hyps_file_name = f'{destination_folder_name}{hyps_file_name.replace("../","")}'
