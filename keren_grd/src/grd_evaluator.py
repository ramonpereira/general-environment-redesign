    ...
    for [domain_file_name,template_file_name,hyps_file_name] in grd_tasks_list:
        ...
        try:
            ...
            #calc latestSplit
                ...
                #create problem
                grd_defs.gen_files_dir = grd_defs.gen_files_dir.replace('src/../gen_files','')
                grd_test_task = grd_task.GrdTask()
                ...
                string_to_print = f'Initial metric: {init_wcd}\nNew metric: {min_wcd}\nExpanded nodes: {explored_op_comb}\nGenerated nodes: {total_num_of_nodes_explored}\nSolution: {opt_op_comb}'
